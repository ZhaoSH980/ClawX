...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'minimax', name: 'MiniMax', icon: '🔮', placeholder: 'sk-...', model: 'MiniMax-M2.5', requiresApiKey: true, defaultBaseUrl: 'https://api.minimaxi.com/v1', defaultModelId: 'MiniMax-M2.5' },
